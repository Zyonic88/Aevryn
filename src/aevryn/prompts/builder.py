...
class CanonPromptBuilder:
    ...
    def build_narration_prompt(
        ...
        return self._join_sections(
            (
                "Create narration using only accepted Aevryn canon.",
                self._analysis_section(analysis),
    ...
    def build_camera_prompt(
        ...
        return self._join_sections(
            (
                "Create camera direction using only accepted Aevryn canon.",
                self._analysis_section(analysis),
    ...
    def build_animation_prompt(
        ...
        return self._join_sections(
            (
                "Create animation direction using only accepted Aevryn canon.",
                self._analysis_section(analysis),
