...
def test_ai_extractor_returns_evidence_bounded_candidates() -> None:
    ...
    assert "manuals/scrolls/jade slips/crystals" in client.prompt
    assert "named physical cores such as energy cores are items" in client.prompt
    ...
    assert "manual, scroll, jade slip, crystal, or physical core as a skill" in client.prompt
