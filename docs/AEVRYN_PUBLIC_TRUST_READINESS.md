...
Public pages are implemented and production-reachable. The public review matrix exists in docs/AEVRYN_PUBLIC_REVIEW_MATRIX.md. Backup retention wording has a public-beta candidate in docs/AEVRYN_BACKUP_RETENTION_DECISION.md. AI provider disclosure has a public-beta candidate in docs/AEVRYN_AI_PROVIDER_DISCLOSURE_DECISION.md. Public beta remains blocked by legal-sensitive wording review, backup retention wording owner/legal review, final provider disclosure wording approval, and final public-beta signoff.
```
