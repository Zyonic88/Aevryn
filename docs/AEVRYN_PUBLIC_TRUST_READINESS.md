...
Public pages are implemented and production-reachable. The public review matrix exists in docs/AEVRYN_PUBLIC_REVIEW_MATRIX.md. Backup retention wording has a public-beta candidate in docs/AEVRYN_BACKUP_RETENTION_DECISION.md. AI provider disclosure has a public-beta candidate in docs/AEVRYN_AI_PROVIDER_DISCLOSURE_DECISION.md, and provider disclosure product-truth wording approval is recorded in docs/AEVRYN_PROVIDER_DISCLOSURE_WORDING_APPROVAL_2026_08_02.md. Public beta remains blocked by legal-sensitive wording review, provider disclosure legal review, backup retention wording owner/legal review, and final public-beta signoff.
```
