# Aevryn V1 Acceptance Criteria

> Built by **Aetherra Labs**

This document defines what **V1 Complete** means for aevryn.
...
The support matrix is maintained in `docs/AEVRYN_IMPORT_FORMAT_MATRIX.md`.
...
* Does not present scraped copyrighted text as Aevryn-owned content
...
After every subsystem reaches V1 complete, Aevryn must pass the Canon Test.
...
If Aevryn can do that with evidence, it is proving the product.
...
Aevryn reaches Release Candidate 1 only when:
...
It means Aevryn is stable enough to prepare for Version 1 release validation.
