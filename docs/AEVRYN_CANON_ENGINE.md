...
The Canon Engine is Aevryn's source of truth for the current state of a story.
...
The Canon Engine exists so Aevryn can remember those changes without asking AI to reconstruct the whole story from scratch every time.
...
Eventually Aevryn will have a graph.
