...
- Branch protection readiness is documented in `docs/AEVRYN_BRANCH_PROTECTION.md` and `docs/AEVRYN_GITHUB_HOSTED_CONTROLS.md`; required hosted checks, secret scanning, push protection, dependency alerts, bypass permissions, and the protected-path drill must be configured and verified in GitHub before public beta.
