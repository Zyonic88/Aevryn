...
- Do not treat Phase 11, Phase 12, or private alpha acceptance as public beta approval; public beta still requires release-candidate readiness, deployment-specific security decisions, legal review, support readiness, backup/recovery/audit readiness, AI provider review, and production infrastructure choices.
