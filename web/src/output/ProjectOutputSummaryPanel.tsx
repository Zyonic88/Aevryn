...
function characterDuplicateReviewItems(
...
function duplicateReviewItem(
  ...
  return {
    ...
    leftName: readableCharacterName(left.display_name),
    rightName: readableCharacterName(right.display_name),
    reason,
  };
}
...
function CharacterPanels({
  ...
  return (
    <div className="large-output-stack">
      <CharacterDuplicateReviewPanel items={duplicateReviewItems} />
...
function CharacterDuplicateReviewPanel({ items }: { items: CharacterDuplicateReviewItem[] }) {
  if (items.length === 0) {
    return null;
  }
  return (
